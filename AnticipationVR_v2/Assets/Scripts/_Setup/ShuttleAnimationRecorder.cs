...
namespace _Setup
{
    public class ShuttleAnimationRecorder : MonoBehaviour
    {
        #region INSPECTOR VARIABLES

        [SerializeField] public GameObject shuttleGameObject;
        ...
        private void CreateNewAnimationRecorder()
        {
            ...
            _animationRecorderSettings.name = $"Shuttle Animation Recorder";
            _animationRecorderSettings.Enabled = true;
            
            // GameObject
            _animationRecorderSettings.AnimationInputSettings.gameObject = shuttleGameObject;
            ...
            _animationRecorderSettings.OutputFile =
                _recordingSettings.shuttleOutputFolder + "/Shuttle_" + _recordingSettings.trialConditionPrefix + "_" +
